...
function App() {
    ...
    return (
        <div className="App list-group-item  justify-content-center align-items-center mx-auto"
            ...
            <h6 className="card text-white bg-primary mb-4">FASTAPI - React - MongoDB</h6>
            <div className="card-body">
                <h5 className="card text-white bg-dark mb-4">Add Your Task</h5>
            ...
            <h6 className="card text-dark bg-info py-1 mb-0" >igruk 2023 &copy;</h6>
        </div>
    );
}
